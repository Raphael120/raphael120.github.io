                ...
                <div class="header__left">
                    ...
                    <div class="header__base-info">
                        ...
                        <ul class="header__social">
                            <li>
                                <a href="#">
                                    <i class="font-icon icon-linkedin" target="blank"></i>
                                </a>
                            </li>
                            <li>
                            ...
                            <li>
                                <a href="#">
                                    <i class="font-icon icon-youtube" target="blank"></i>
                                </a>
                            </li>
                            <li>
                                <a href="#">
                                    <i class="font-icon icon-twitter" target="blank"></i>
                                </a>
                            </li>
                ...
                <aside class="col-12 col-md-12 col-lg-2">
                    <div class="sidebar box sticky-column">
                        <ul class="nav">
                            ...
                            <li class="nav__item"><a href="works.php"><i class="icon-codesandbox"></i>Portfólio</a>
                            </li>
                        </ul>
                    </div>
                </aside>
                            ...
                            <div class="col-12">
                                ...
                                <div class="timeline">
                                    ...
                                    <article class="timeline__item">
                                        <h5 class="title title--h5 timeline__title">Curso Técnico em informática</h5>
                                    ...
                                    <!-- Item -->
                                    <article class="timeline__item">
                                        <h5 class="title title--h5 timeline__title">Licenciatura em Educação Física
                                        </h5>
                                        <span class="timeline__period">2017 — Atualmente</span>
                                    ...
                                    <article class="timeline__item">
                                        <h5 class="title title--h5 timeline__title">
                                            Programação Orientada a Objetos em Python - SPP
                                        </h5>
                                        <span class="timeline__period">2020</span>
                                        <p class="timeline__description">YouTube</p>
                                    </article>
                                    <!-- Item -->
                                    ...
                                    <article class="timeline__item">
                                        ...
                                        <span class="timeline__period">2020 - Atualmente</span>
                                        <p class="timeline__description">Programa Novos Caminhos</p>
                                    </article>
                                    <!-- Item -->
                                    <article class="timeline__item">
                                ...
                                <div class="box box__border">
                                    ...
                                    <div class="progress">
                                        <div class="progress-bar" role="progressbar" aria-valuenow="45"
                                            ...
                                            <div class="progress-text"><span>PHP</span><span>45%</span></div>
                                        </div>
                                    ...
                                    <div class="progress">
                                        <div class="progress-bar" role="progressbar" aria-valuenow="45"
                                            aria-valuemin="0" aria-valuemax="100">
                                            <div class="progress-text"><span>CSS</span><span>45%</span></div>
                                        </div>
                                    ...
                                    <div class="progress">
                                        <div class="progress-bar" role="progressbar" aria-valuenow="45"
                                            aria-valuemin="0" aria-valuemax="100">
                                            <div class="progress-text"><span>HTML</span><span>45%</span></div>
                                        </div>
                                    ...
                                    <div class="progress">
                                        <div class="progress-bar" role="progressbar" aria-valuenow="40"
                                            aria-valuemin="0" aria-valuemax="100">
                                            <div class="progress-text"><span>Python</span><span>40%</span></div>
                                        </div>
