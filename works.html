...
<head>
    <meta charset="utf-8" />
    <title>Raphael da Silva Araújo</title>

    <!-- Meta Data -->
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
    <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">

    <meta name="author" content="Raphael da Silva Araújo" />
    <meta name="description" content="Portfólio de trabalhos realizados e formação de Raphael da Silva Araújo" />
    <!-- Styles -->
            ...
            <header class="header box">
                <div class="header__left">
                    <div class="header__photo">
                        <!-- COLOCAR FOTO -->
                        <img class="header__photo-img" src="assets/img/semfoto.png" alt="Raphael da Silva Araújo">
                    </div>
                    <div class="header__base-info">
                        <h4 class="title titl--h4">Raphael da Silva Araújo</h4>
                        ...
                        <ul class="header__social">
                            ...
                            <li>
                                <a href="https://github.com/Raphael120" target="blank">
            ...
            <div class="row sticky-parent">
                ...
                <div class="col-12 col-md-12 col-lg-10">
                    <div class="box box-content">
                        <div class="pb-2">
                            <h1 class="title title--h1 first-title title__separate">Portfólio</h1>
                        </div>
                        ...
                        <div class="pb-0">
                            ...
                            <div class="select">
                                ...
                                <ul class="filter">
                                    ...
                                    <li class="filter__item" data-filter=".category-python"><a class="filter__link"
                                            href="#filter">Python</a></li>
                                </ul>
                            ...
                            <div class="gallery-grid js-grid-row js-filter-container">
                                ...
                                <!-- Item 1 -->
                                <figure
                                    class="gallery-grid__item category-html category-wordpress category-php category-python category-js">
                                    <div class="gallery-grid__image-wrap">
                                        <img class="gallery-grid__image cover lazyload" src="assets/img/github.jpg"
                                            data-zoom alt="" />
                                    </div>
                                    <figcaption class="gallery-grid__caption">
                                        <h4 class="title title--h6 gallery-grid__title">GitHub</h4>
                                        <span class="gallery-grid__category">github.com/Raphael120 </span>
                                    </figcaption>
                                </figure>

                                <!-- Item 2 -->
                                <figure class="gallery-grid__item category-php category-html category-js">
                                    <div class="gallery-grid__image-wrap">
                                        <img class="gallery-grid__image cover lazyload"
                                            src="assets/img/novos_caminhos.jpg" data-zoom alt="" />
                                    </div>
                                    <figcaption class="gallery-grid__caption">
                                        <h4 class="title title--h6 gallery-grid__title">Programador WEB - Novos Caminhos
                                        </h4>
                                        <span class="gallery-grid__category">github.com/Raphael120/novos_caminhos
                                        </span>
                                    </figcaption>
                                </figure>

                                <!-- Item 3 -->
                                <figure class="gallery-grid__item category-python">
                                    <div class="gallery-grid__image-wrap">
                                        <img class="gallery-grid__image cover lazyload" src="assets/img/python.jpg"
                                            data-zoom alt="" />
                                    </div>
                                    <figcaption class="gallery-grid__caption">
                                        <h4 class="title title--h6 gallery-grid__title">Pythonbirds</h4>
                                        <span class="gallery-grid__category">github.com/Raphael120/pythonbirds
                                        </span>
                                    </figcaption>
                                </figure>
                    ...
                    <!-- Footer -->
                    <footer class="footer">© Raphael da Silva Araújo</footer>
                </div>
            </div>
        </div>
    </main>
